...
import com.example.overdex.battle.debug.observatory.MatchRecording
...
@Composable
fun MatchSummaryCard(recording: MatchRecording) {
    ...
    Column {
        TerminalSection(title = "MATCH SUMMARY") {
            Row(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.weight(1f)) {
                    TerminalText(text = "ID: ${recording.matchId.take(8)}...", color = TerminalPurple, fontSize = 12.sp)
